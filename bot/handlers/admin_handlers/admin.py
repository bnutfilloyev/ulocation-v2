...
async def start_partner_add(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    await callback_query.message.answer("📝 <b>Yangi partnyor qo‘shamiz!</b>\n\n"
                                        "👤 Iltimos, partnyorning <b>nomini</b> kiriting:", parse_mode="HTML")
...
async def process_partner_name(message: types.Message, state: FSMContext):
    ...
    await message.answer("📌 Endi partnyor uchun <b>login</b> kiriting:", parse_mode="HTML")
...
async def process_partner_login(message: types.Message, state: FSMContext):
    ...
    await message.answer("🔑 Endi partnyor uchun <b>parol</b> kiriting:", parse_mode="HTML")
...
async def show_partner_delete_list(callback_query: types.CallbackQuery):
    ...
    if not partners:
        await callback_query.message.answer("❌ <b>Hozirda hech qanday partnyor mavjud emas.</b>", parse_mode="HTML")
