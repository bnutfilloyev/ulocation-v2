from mongoengine import Document, StringField, DateTimeField, BooleanField, FloatField, ListField, EmbeddedDocument, EmbeddedDocumentField
import datetime
...
class User(Document):
    ...
    def __str__(self):
        return self.input_fullname or f"{self.first_name} {self.last_name}".strip() or f"User {self.user_id}"
